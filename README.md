# JavaFXTicTacToeJBwithoutFXMLVers2
...
- FXML1Controller.java (without FXML)  handle graphic user interface displaying board of the game, 3x3 grid board, symbols used, stats, restart and new game buttons  
